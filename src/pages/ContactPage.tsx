  ...
  const contactInfo = [
    {
      icon: Mail,
      label: ci.emailLabel,
      values: ['trading@bbst.global', 'info@bbst.global'],
      sub: ci.emailSub,
    },
    {
      icon: Phone,
      label: ci.phoneLabel,
      values: ['+968 92882417', '+968 71119624'],
      sub: ci.phoneSub,
    },
    {
      icon: MapPin,
        ...
        <div className="grid lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-slate-500 text-sm leading-relaxed">{t.contact.infoSubtitle}</p>
            </div>

            <div className="space-y-4">
              {contactInfo.map(({ icon: Icon, label, values, sub }) => (
                <div
                  key={label}
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-lg p-8 lg:p-10">
              {status === 'success' ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <p className="text-slate-500 max-w-sm">{t.contact.successMsg}</p>
                  <button
