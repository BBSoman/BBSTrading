    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <div className="bg-gradient-to-r from-[#464EB8] to-[#2B5EB8] text-white px-6 py-5 rounded-t-2xl flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/75 text-sm">Schedule a Teams call with our trading team</p>
            </div>
          </div>
        ...
        <div className="p-8 text-center">
          ...
          <h4 className="text-xl font-bold text-slate-900 mb-2">Check Our Availability</h4>
          <p className="text-slate-500 text-sm mb-8 leading-relaxed">
            You'll be taken to our Microsoft Bookings page where you can see real available slots and confirm your appointment instantly.
          </p>

          {/* Steps */}
          <div className="text-left space-y-3 mb-8 bg-slate-50 rounded-xl p-4">
            {[
              'Pick a service & available time slot',
              'Enter your name and email',
              'Receive a Teams meeting invite by email',
            ].map((step, i) => (
          ...
          <p className="mt-3 text-slate-400 text-xs">Opens in a new tab · Powered by Microsoft Bookings</p>
        </div>
      </div>
    </div>
  );
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            ...
            <p className="mt-3 text-slate-400 text-sm">Schedule a virtual meeting with our trading team</p>
          </div>
        </div>
      </section>
